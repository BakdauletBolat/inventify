...
class Modification(models.Model):
    ...
    engineDisplacement = models.FloatField(default=None, null=True, blank=True, verbose_name='Вместимость')
    ...
    steeringType = models.ForeignKey(SteeringType, verbose_name='Тип рулевого управления', **default_fk_param)
