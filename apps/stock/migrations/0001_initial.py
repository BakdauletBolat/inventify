    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='stock.quality')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=255)),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='handbook.city')),
            ],
            options={
                'verbose_name': 'Склад',
